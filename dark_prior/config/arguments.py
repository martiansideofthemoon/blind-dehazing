...
parser.add_argument("-ip", "--input", default="data/cones.png", type=str, help="Input image file")
...
parser.add_argument("-c", "--constants", default="dark_prior/config/constants.yml", type=str, help="Predefined constants")
